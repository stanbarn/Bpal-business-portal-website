...
var XenteApp = function (){
    return {
        ...
        blockPage: function (options) {
            return XenteApp.block('body', options);
        },

        unblockPage: function () {
            return XenteApp.unblock('body');
        },
...
// Initialize XenteApp class on document ready
